  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-zinc-200 flex flex-col justify-between">
        ...
        <span className="text-3xl font-black text-zinc-900 mt-2">${kpis.revenue.toFixed(2)}</span>
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-zinc-200 flex flex-col justify-between">
        ...
        <span className="text-3xl font-black text-indigo-600 mt-2">${kpis.netProfit.toFixed(2)}</span>
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-zinc-200 flex flex-col justify-between">
        ...
        <span className="text-3xl font-black text-zinc-900 mt-2">{kpis.salesCount} tkts</span>
